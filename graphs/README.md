...
<table border = "10px"; border-style = "ridge"; align = "center"; width="1000">
  <tr> 
    <td width="500"; height="150"> <div align="center"> <img src="https://github.com/MatteoFasulo/PyTripAdvisor/blob/main/img/food_all.png?raw=true"
     alt="Markdown Monster icon"
     style="float: left; margin-right: 10px" /> </div> </td>
    <td width="500"; height="150"> <div align="center"> <img src="https://github.com/MatteoFasulo/PyTripAdvisor/blob/main/img/pizza_50.png?raw=true"
     alt="Markdown Monster icon"
     style="float: left; margin-right: 10px" /> </div> </td>
  </tr>
  <tr> 
  ...
  <tr> 
    <td width="500"; height="150"> <div align="center"> <img src="https://github.com/MatteoFasulo/PyTripAdvisor/blob/main/img/burger_50-1000.png?raw=true"
     alt="Markdown Monster icon"
     style="float: left; margin-right: 10px" /> </div> </td>
    <td width="500"; height="150"> <div align="center"> <img src="https://github.com/MatteoFasulo/PyTripAdvisor/blob/main/img/frutta_+1000.png?raw=true"
     alt="Markdown Monster icon"
     style="float: left; margin-right: 10px" /> </div> </td>
  </tr>
  <tr> 
